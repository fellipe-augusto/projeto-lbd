...
INSERT INTO tbOcorrencia VALUES (007, 006, 005, '29/05/2019', 'Reparo concluÃ­do na visita', 2);
...
Não. Pois a visão realiza as operações de junção. Um view não é atualizável
quando tem junção, operadores como group by, having, sum, max, min e ter campos de calculo
