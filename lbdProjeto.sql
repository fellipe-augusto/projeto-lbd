...
INSERT INTO tbCliente VALUES (004, 'Jo√£o Kleber', '95684-4857', 'Rua Amap√°');
INSERT INTO tbCliente VALUES (005, 'Jos√© Luiz Datena', '95684-4857', 'Rua Ponta Grossa');
...
--4.11
-- A cl·usula having serve para especificar um critÈrio de pesquisa/filtro para um resultado agrupado.
--Objetivo:

--4.12
--Objetivo: Este comando serve para listar os produtos/descriÁ„o que est„o com solicitaÁ„o em andamento.
SELECT idProduto, descricao
FROM tbProduto
WHERE idProduto IN (SELECT idProduto FROM tbSolicitacao WHERE situacao='Fechado');

--4.13
--Objetivo: Este comando serve para listar todos os clientes que n„o abriram solicitaÁıes.
SELECT idCliente 
FROM tbCliente 
